import ZebraChainArithSpec

/-!
# `ZebraChainArith` Proofs

This file discharges every specification declared in
[`ZebraChainArithSpec.lean`](ZebraChainArithSpec.lean) by reducing it to the
inline theorems proved in
[`ZebraChainArith/Height.lean`](ZebraChainArith/Height.lean),
[`ZebraChainArith/Amount.lean`](ZebraChainArith/Amount.lean), and
[`ZebraChainArith/CompactSize.lean`](ZebraChainArith/CompactSize.lean).
...
namespace ZebraChainArith.Proofs

open Zebra
open ZebraChainArith.Spec
